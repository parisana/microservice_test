...
public class PostHandlerTest {
    ...
    static final Logger logger = LoggerFactory.getLogger(PostHandlerTest.class);
    ...
    @Test
    public void testPostPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/post?your_name=15";
